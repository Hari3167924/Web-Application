...
//     window.location.href = "/payment"; // React Router path
//   };

//   return (
//     <div className="orders-page">
//       <Navbar />
//       <header className="header">Your Orders</header>
...
//     <p>Payment: {order.payment || "Not selected"}</p>
//     <p>Status: {order.status}</p>

//     <button onClick={() => goToPayment(index)}>Pay Now</button>
